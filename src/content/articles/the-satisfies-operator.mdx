...
TypeScript 4.9 introduces a new `satisfies` operator that acts as a happy compromise between `:` annotations and the default type inference.
...
> [Here's a TypeScript playground with the Next.js `GetServerSideProps` example](https://www.typescriptlang.org/play?ts=5.0.0-dev.20221114#-EA).
